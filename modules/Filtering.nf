...
process Filtering {
    ...
    gatk IndexFeatureFile --I ${called_low_vcf}.low.vcf
    ...
    gatk IndexFeatureFile --I ${called_unfixed_vcf}.unfixed.vcf
    ...
    gatk IndexFeatureFile --I ${called_fixed_vcf}.fixed.vcf
    """
